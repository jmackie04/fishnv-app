    ...
    <header class="py-8 bg-blue-300">
      ...
      >
        <div class="flex-1 min-w-0">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ml-4 text-sm text-gray-500 hover:text-gray-700">Washoe County</a>
                </div>
              </li>
              <li>
                <div class="flex items-center">
          ...
          >
            Galena Creek
            <span class="ml-2 text-lg font-normal text-gray-500">WA-6</span>
          </h1>

          <div class="flex flex-row flex-wrap gap-x-2 gap-y-1 mt-2">
            <div
              class="px-3 py-1 text-xs md:text-sm bg-gray-50 shadow-sm inline-block rounded"
            >Rainbow Trout</div>
            <div
              class="px-3 py-1 text-xs md:text-sm bg-gray-50 shadow-sm inline-block rounded"
            >Brook Trout</div>
        ...
        <div class="mt-2 flex xl:mt-0 xl:ml-4">
          <span class="block">
            <button
              type="button"
              class="inline-flex items-center drop-shadow-md p-2 bg-transparent text-gray-500 hover:text-red-400 focus:rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-olive-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
